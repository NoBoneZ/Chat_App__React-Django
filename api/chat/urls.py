...
from .views import (conversation_list_view, conversation_create_view,
                    ...
                    message_update_view, message_delete_view, user_conversation_view,
...
urlpatterns = [
    ...
    path("user_conversation/<int:pk>/", user_conversation_view, name="user_conversation"),

    path("conversation_messages/<int:pk>/",conversation_messages_view, name="conversation_messages"),
